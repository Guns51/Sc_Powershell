...
while ($true)
{
    switch ((Receive-Job jobState -ErrorAction Stop)| select -Last 1) 
    {
        ...
        "InProgress" {$_;Start-Sleep -Seconds 1;break}
        ...
        "Lobby" {
            ...
            $gameSession = Get-Content -Path "C:\Users\gunsa\Desktop\Sc_Powershell\vartest2.txt" | ConvertFrom-Json
            ...
            while(((Receive-Job jobState)| select -Last 1) -cin "Lobby")#Tant que le gameFlow est toujours en "InProgress" : attendre 
            {
